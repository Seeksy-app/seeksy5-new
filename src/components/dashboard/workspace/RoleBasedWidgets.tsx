...
const ALL_WIDGETS: WidgetConfig[] = [
  ...
  { id: "mypage", moduleId: "my-page", title: "Shareable Profile Page", description: "Your link-in-bio", icon: Link2, path: "/profile/edit", color: "from-violet-500 to-purple-500", bgColor: "hover:bg-[hsl(270,80%,97%)]", iconBg: "bg-[hsl(270,70%,95%)]", iconColor: "text-[hsl(270,70%,50%)]" },
